       ...
       <div class="container">
           <div class="row">
                <div class="form-comments">
                    ...
                    <br>
                    <form class="form-a" id="form2" action="<?= base_url("Client/Profil/changePassword/") ?>" method="POST">
    ...
    <script type="text/javascript">
        ...
        function sendPassword() {
            ...
            Swal.fire({
                ...
                preConfirm: (password) => {
                    if (password != "") {
                        return fetch(location.href = "<?= base_url("Client/Profil/changeMail/") ?>" + "/" + email.value + "/" + password)
                    }
                    else
                    {
