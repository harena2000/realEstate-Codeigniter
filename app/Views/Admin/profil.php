                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      ...
                      <p>
                        ...
                        <span class="color-text-a"> 
                          <?= $status = ($liste->status == 0) ? "Single" : "Married";?> 
                        </span>
                      </p>
                      <p>
              ...
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                    ...
                    <a href="<?php echo base_url('Admin/House/index') . "/" . $house->idMaison . "/$house->idAgence"?>" class="link-a">Click here to view
                      <span class="ion-ios-arrow-forward"></span>
                    </a>
                  </div>
