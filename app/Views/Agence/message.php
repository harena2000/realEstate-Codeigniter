...
<section class="intro-single" style="margin-top:-80px">
  <div class="container">
    ...
    <a href="<?= base_url("Agence/Ajoutermembre/index/$nameGroup") ?>">
        <button style="margin-left : 30px" class="btn btn-success"><i class="fas fa-user-plus" aria-hidden="true"></i>  Add Membre</button>
    </a>
  </div>
...
$(document).ready(() => {
    ...
    function showMsg() {
        $.ajax({
            type:"GET",
            url: "<?= base_url("Agence/Message/loadMessage") ?>",
            async: true,
            ...
            success: function (data) {
                ...
                for (let index = 0; index < data.length; index++) {
                    ...
                    if (data[index].email != "<?= $emailAgence ?>") {
                        html += "<li>" +
    ...
    send.addEventListener('click',(e) => {
        ...
        $.ajax({
            type:"POST",
            url:"<?= base_url("Agence/Message/sendMessagePage") ?>",
            dataType : "JSON",
