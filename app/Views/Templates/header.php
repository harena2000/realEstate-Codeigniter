...
<body>
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 1) echo 'active'; else echo '' ?>" href="<?php echo base_url('Client/Acceuil')?>">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 2) echo 'active'; else echo '' ?>" href="<?php echo base_url('Client/Allhouse')?>">All House</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 3) echo 'active'; else echo '' ?>" href="<?php echo base_url('Client/Sale')?>">For Sale</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 4) echo 'active'; else echo '' ?>" href="<?php echo base_url('Client/Payment')?>">Payment</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 5) echo 'active'; else echo '' ?>" href="<?php echo base_url('Client/Checklist')?>">Check</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 7) echo 'active'; else echo '' ?>" href="<?php echo base_url('Client/Listmessage')?>">Chat</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link <?php if($isActive == 6) echo 'active'; else echo '' ?> dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fas fa-sun-o" aria-hidden="true"></i> Setting
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?php echo base_url('Client/Profil')?>">My Profil</a>
              <a class="dropdown-item" href="<?php echo base_url('Client/Profil/AccountSetting')?>">Account Setting</a>
            </div>
          </li>
          <li class="nav-item">
  ...
  function alertSearch() {
    Swal.fire({
      ...
      preConfirm: (title) => {
          if (title != "") {
            return fetch(location.href = "<?= base_url("Client/Search/index") ?>" + "/" + title)
          }
          else
          {
