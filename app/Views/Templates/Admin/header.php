    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 1) echo 'active'; else echo '' ?>" href="<?php echo base_url('Admin/Acceuil')?>">Home</a>
          </li>

          <li class="nav-item dropdown">
            <a class="nav-link <?php if($isActive == 2) echo 'active'; else echo '' ?> dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fas fa-home" aria-hidden="true"></i> House
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?php echo base_url('Admin/Allhouse')?>">All House</a>
              <a class="dropdown-item" href="<?php echo base_url('Admin/Sale')?>">For Sale</a>
              <a class="dropdown-item" href="<?php echo base_url('Admin/Housesold')?>">House Sold</a>
            </div>
          </li>
          
          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 5) echo 'active'; else echo '' ?>" href="<?php echo base_url('Admin/Allusers')?>">Users</a>
          </li>

          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 7) echo 'active'; else echo '' ?>" href="<?php echo base_url('Admin/Allagents')?>">Agents</a>
          </li>

          <li class="nav-item">
            <a class="nav-link <?php if($isActive == 6) echo 'active'; else echo '' ?>" href="<?php echo base_url('Admin/Manage')?>">Manage</a>
          </li>
          <li class="nav-item">
...
<script type="text/javascript">
  ...
  function alertSearch() {
    Swal.fire({
      ...
      preConfirm: (title) => {
          if (title != "") {
            return fetch(location.href = "<?= base_url("Admin/Search/index") ?>" + "/" + title)
          }
          else
          {
