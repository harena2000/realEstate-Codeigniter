...
<html lang="en">
  <head>
    ...
    <link href="<?php base_url("assets/login/css/bootstrap.min.css")?>" rel="stylesheet">
  ...
  <body class="img js-fullheight" style="background-image:url(<?php echo base_url("assets/img/post-6.jpg")?>);background-size: cover;background-repeat: repeat;">
        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-7">
            <div class="login-wrap p-0">
              <h3 class="mb-4 text-center">Agency account</h3>

              <!-- Formulaire -->

              <form id="form" action = "<?= base_url('Signup/agent')?>" method="post">
                <div class="row">
                  <div class="col">
                    <!-- Name -->
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <input type="date" name="dateNaissance" class="dateNaissance form-control" placeholder="Your birthday">
                  </div>
                </div>
                ...
                <div class="row">
                  <!-- Experience -->
                  <div class="col">
                    <input type="number" placeholder="Year of Experience" name="experience" class="experience form-control" placeholder="Your Profession" autofocus>
                  </div>
                  ...
                  <div class="col">
                    ...
                    <select name="status" class="status form-control">
                      ...
                      <option style="color: black;" value="0">Single</option>
                      <option style="color: black;" value="1">Married</option>
                    </select>
                  </div>
                </div>
    ...
    <script src="<?php echo base_url("assets/login/validationAgence.js")?>"></script>
